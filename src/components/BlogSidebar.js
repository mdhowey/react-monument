  ...
  return (
    <div>
      <aside>
			...
			<h3>Recent Issues</h3>
			<ul>
				<li><a href="#stink">Issue Nineteen &mdash; Camping</a></li>
				<li><a href="#stink">Issue Eighteen &mdash; Food</a></li>
				<li><a href="#stink">Issue Seventeen &mdash; Signs</a></li>
				<li><a href="#stink">Issue Sixteen &mdash; Friends</a></li>
				<li><a href="#stink">Issue Fifteen &mdash; Carnivals</a></li>
				<li><a href="#stink">Issue Fourteen &mdash; Gatherings</a></li>
			</ul>
		</aside>
    </div>
  )
